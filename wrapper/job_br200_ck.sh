...
PREPROCESS_DIR="/N/slate/ckieu/tmp"
cd /N/u/ckieu/BigRed200/model/regDL-TCIP/wrapper #"$ROOT"

# ------------------------------------------------------------------------------
# Flags (1=run, 0=skip)
# ------------------------------------------------------------------------------
CMIP6_WRF=(0 0)        # [0]=step1 (crop), [1]=step2 (npy)
WRF_IDEALIZED=(1)      # [0]=idealized pipeline (placeholder)
TRAINING=(0 0 0)       # [0]=build, [1]=feed, [2]=train
...
ideal_wrf_root="/N/slate/ckieu/tmp/"
ideal_x_res="d01"
ideal_var_levels=(
  U10m V10m SST LANDMASK
  U14 V14 U03 V03
